        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight text-foreground">
              ייעוץ גיוס אסטרטגי<br />לחברות טכנולוגיה
            </h1>
            ...
            <Card className="p-8 hover:shadow-xl transition-all duration-300 relative">
              ...
              <div className="relative z-10">
                ...
                <div className="border-t pt-4">
                  ...
                  <p className="text-sm text-muted-foreground">מנהלת גיוס EMEA, Checkpoint</p>
                </div>
              </div>
            </Card>
            ...
            <Card className="p-8 hover:shadow-xl transition-all duration-300 relative">
              ...
              <div className="relative z-10">
                ...
                <div className="border-t pt-4">
                  ...
                  <p className="text-sm text-muted-foreground">Director of Global Talent Acquisition, Monday</p>
                </div>
              </div>
            </Card>
            ...
            <Card className="p-8 hover:shadow-xl transition-all duration-300 relative">
              ...
              <div className="relative z-10">
                ...
                <div className="border-t pt-4">
                  ...
                  <p className="text-sm text-muted-foreground">Senior Manager, Talent Acquisition at Gong.io</p>
                </div>
              </div>
            </Card>
          </div>
